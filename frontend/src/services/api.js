...
// --- THIS IS THE CHANGE ---
// 1. It looks for the Vercel variable `import.meta.env.VITE_API_URL`
// 2. If it can't find it (like when running locally), it uses our test URL.
...
/**
 * The function to generate a new quiz.
...
/**
 * The function to get the quiz history.
...
/**
 * The function to get a single quiz by its ID.
 * It makes a GET request to our /quiz/{quiz_id} endpoint.
 * @param {number} quizId - The ID of the quiz to fetch.
 *a * @returns {object} The full quiz data for that specific quiz.
 */
